...
/**
 * The account entity encapsulating all the account
 * attributes
 *
 * @author spenap
 */
...
public class Account implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        return accountId.equals(theOther.accountId) && user.equals(theOther.user) && name.
                equals(theOther.name) && balance == theOther.balance && version == theOther.version;
    }
    ...
    public int hashCode() {
        int hash = 7;
        hash =
                79 * hash + (this.accountId != null ? this.accountId.hashCode() : 0);
        hash = 79 * hash + (this.name != null ? this.name.hashCode() : 0);
        hash = 79 * hash + (this.user != null ? this.user.hashCode() : 0);
        hash =
                79 * hash + (int) (Double.doubleToLongBits(this.balance) ^ (Double.
                doubleToLongBits(this.balance) >>> 32));
